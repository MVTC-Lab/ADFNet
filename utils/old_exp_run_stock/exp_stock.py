...
from data_process.etth_data_loader import Dataset_ETT_hour, Dataset_ETT_minute, Dataset_Custom, Dataset_Pred, Dataset_Daily
...
class Exp_stock(Exp_Basic):
    ...
    def _get_data(self, flag):
        ...
        data_dict = {
            ...
            'stock':Dataset_Daily,
            'indexProcessed':Dataset_Daily,
            'gspc_reverse':Dataset_Daily,
    ...
    def train(self, setting):
        ...
        if not os.path.exists(path):
            os.makedirs(path)
        writer = SummaryWriter('/home/fuqiang/projects/SCINetmainWithTFEDNC3/event/run_stock/{}'.format(self.args.model_name))
        ...
        log_file = os.path.join(log_dir, 'stock_results.txt')
        ...
        log_content = (
            ...
            f"Model Config: seq_len={self.args.seq_len}, pred_len={self.args.pred_len}, "
            f"data={self.args.data}, hidden_size={self.args.hidden_size}, stacks={self.args.stacks}, fft={self.args.f}, frets={self.args.frets}, decompose={self.args.decompose}, fft_ratio={self.args.fft_ratio}, use_fft={self.args.use_fft}, fft_mode={self.args.fft_mode}\n"
            "Normalized Metrics:\n"
